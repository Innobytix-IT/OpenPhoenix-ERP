...
class XRechnungPanel(QWidget):
    ...
    def _on_theme_changed(self, _mode: str) -> None:
        """Baut das Panel mit neuen Farben neu auf."""
    ...
    def _build_header(self) -> QFrame:
        header = QFrame()
        header.setObjectName("xrechnungPanelHeader")
        header.setFixedHeight(64)
        header.setStyleSheet(f"""
            #xrechnungPanelHeader {{
    ...
    def _build_auswahl_tab(self) -> QWidget:
        ...
        # Toolbar
        toolbar = QWidget()
        toolbar.setObjectName("xrechnungToolbar")
        toolbar.setStyleSheet("#xrechnungToolbar { background: transparent; }")
