"""
ui/modules/rechnungen/kunden_auswahl.py – Kundenauswahl für neue Rechnungen
============================================================================
Schneller Dialog zum Auswählen eines aktiven Kunden bevor eine Rechnung
angelegt wird.
"""
...
class KundenAuswahlDialog(QDialog):
    """
    Minimalermodaler Dialog zur Kundenauswahl.

    Signals:
        selected(int, str): Kundennummer und Anzeigename des gewählten Kunden
    """
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Kunde für Rechnung auswählen")
        self.setModal(True)
