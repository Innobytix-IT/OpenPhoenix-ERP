...
class KundenDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        scroll = QScrollArea()
        scroll.setObjectName("kundenDialogScroll")
        scroll.setWidgetResizable(True)
        scroll.setFrameShape(QFrame.Shape.NoFrame)
        scroll.setStyleSheet("#kundenDialogScroll { background: transparent; }")
    ...
    def _build_form(self) -> QWidget:
        container = QWidget()
        container.setObjectName("kundenDialogForm")
        container.setStyleSheet("#kundenDialogForm { background: transparent; }")
