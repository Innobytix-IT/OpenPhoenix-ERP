...
class NotizenWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._scroll.setObjectName("notizenScroll")
        self._scroll.setStyleSheet("#notizenScroll { background: transparent; }")
        self._scroll.setMinimumHeight(140)
        self._scroll.setMaximumHeight(220)

        self._list_widget = QWidget()
        self._list_widget.setObjectName("notizenListWidget")
        self._list_widget.setStyleSheet("#notizenListWidget { background: transparent; }")
